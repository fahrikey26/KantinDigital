               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ asset('AdminLTE-3.2.0') }}/index.html" class="nav-link">
                                ...
                                <li class="nav-item">
                                    <a href="{{ asset('AdminLTE-3.2.0') }}/index3.html" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Dashboard v3</p>
                                    </a>
                                </li>
                ...
                <div class="error-page">
                    ...
                    <div class="error-content">
                        ...
                        <p>
                            ...
                            Meanwhile, you may <a href="{{ asset('AdminLTE-3.2.0') }}/index.html">return to
                                dashboard</a> or try using the
                            search form.
                        </p>
